(ns printpressmfg.sim
  ...
  Systems) machinery-safety conformity mark (permanently blocked, no
  ...
  batch patch with an implausible registration-accuracy reading, and a
...
(defn -main [& _args]
  (let [db (-> (store/mem-store) (store/sample-data!))
    ...
    (println "== schedule-maintenance mnt-2 on bench-002 (UNVERIFIED/unregistered commissioning bench -> HARD hold) ==")
    ...
    (println "== log-production-batch batch-001 with an implausible registration-accuracy reading -> HARD hold ==")
