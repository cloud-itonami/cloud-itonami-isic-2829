(ns printpressmfg.phase
  "Phase 0->3 staged rollout for the other-special-purpose-machinery
  (ISIC 2829) plant-operations coordination actor, illustrated with
  industrial printing-press manufacturing (offset presses,
  flexographic presses, gravure presses, digital-inkjet presses,
  screen-printing presses, die-cutting presses).
  ...
  consequence (a fabrication/assembly-commissioning-bench-equipment
  ...
  `printpressmfg.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Special-Purpose Machinery Plant Operations Governor verdict to
