...
`cloud-itonami-isic-2829` is an OSS open-business blueprint for
special-purpose-machinery plant operations coordination.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- a fabrication/assembly-line-equipment action the governor refuses is never dispatched to hardware.
- the Special-Purpose Machinery Plant Operations Governor remains independent of the advisor.
