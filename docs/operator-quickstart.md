# Operator Quickstart — Manufacture of other special-purpose machinery

Shortest path from clone to a verified local dry-run for **ISIC 2829** (`cloud-itonami-isic-2829`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2829.git
cd cloud-itonami-isic-2829
```
...
- Blueprint governor key: `special-purpose-machinery-plant-operations-governor`
- Likely source path: `printpressmfg.governor.cljc`
