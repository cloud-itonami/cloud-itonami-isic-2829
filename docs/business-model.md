# Business Model: Manufacture of other special-purpose machinery
...
## Classification
- Repository: `cloud-itonami-isic-2829` ([github.com/cloud-itonami/cloud-itonami-isic-2829](https://github.com/cloud-itonami/cloud-itonami-isic-2829))
- ISIC Rev.5: `2829` — Manufacture of other special-purpose machinery
- Domain: `:special-purpose-machinery/manufacturing`
- Social impact: :worker-safety :equipment-safety :quality-defect-transparency
- Actor: `:special-purpose-machinery-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :special-purpose-machinery/manufacturing — who wants
...
One managed tenant (:special-purpose-machinery/manufacturing):
...
- Do not bypass the `:special-purpose-machinery-plant-operations-governor` for production decisions.
